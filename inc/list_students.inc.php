...
<table id="listTable" cellspacing="0">
    ...
    <?php
        foreach ($students as $u) {
            ...
            . '<td>' . $u[5] . '</td>'
            . '<td>' . $u[6] . '</td>'
            . '<td><form name="input" action="edit_student_page.html" method="post"><input type="hidden" name="id" value="' . $u[0] . '"><input type="submit" value="Bearbeiten" id="submit"></form></td>'
            . '<td><form name="input" action="delete_student_page.html" method="post"><input type="hidden" name="id" value="' . $u[0] . '"><input type="submit" value="L&ouml;schen" id="submit"></form></td>'
            . '</tr>';
        }
    ?>
</table>