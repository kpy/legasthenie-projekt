...
<form class="admin" action="./inc/create_user.inc.php" method="POST">
    ...
    <fieldset id="auswahl">
    	<label>Typ: </label>
	    <input type="radio" name="typ" value="schueler" onclick="checkClickedUser();" <?php if(empty(hasRight(CREATE_STUDENT, $_SESSION['rights']))) print "disabled"?> 
	    <?php if($_GET["typ"]=="schueler") print "checked"?> >
	    <label> Schüler</label>
	    <input type="radio" name="typ" value="lehrer" onclick="checkClickedUser();" <?php if(empty(hasRight(CREATE_TEACHER, $_SESSION['rights']))) print "disabled" ?>
	    <?php if($_GET["typ"]=="lehrer") print "checked"?> >
	    <label> Lehrer</label>
	    <input type="radio" name="typ" value="admin" onclick="checkClickedUser();" <?php if(empty(hasRight(CREATE_ADMIN, $_SESSION['rights']))) print "disabled"?> 
	    <?php if($_GET["typ"]=="admin") print "checked"?> >
...
<?php 
	...
	( hasRight(CREATE_TEACHER, $_SESSION['rights']) || hasRight(CREATE_ADMIN, $_SESSION['rights']) || hasRight(CREATE_STUDENT, $_SESSION['rights']) ) ) {
?>
			<tr>
...
?>
<?php 
    if ( ($_GET["typ"] == "lehrer" || $_GET["typ"] == "admin") && ( (hasRight(CREATE_TEACHER, $_SESSION['rights']) || hasRight(CREATE_ADMIN, $_SESSION['rights'])) ) ) {
?>
    		<tr>
    		...
    		<tr>
        		...
        		<td><input id="username" type="username" name="username" placeholder="Username" required></td>
    		</tr>
    		<tr>
...
<?php   	
    ...
    if ($_GET["typ"] == "schueler" && hasRight(CREATE_STUDENT, $_SESSION['rights'])) {    	
?>
    <tr>
